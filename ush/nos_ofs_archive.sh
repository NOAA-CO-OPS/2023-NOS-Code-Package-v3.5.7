...
#    then 
     if [ -s $COMOUT/${PREFIXNOS}.2ds.n003.$PDY.t${cyc}z.nc ]; then
       for combinefields in `ls $COMOUT/${PREFIXNOS}.2ds.n*t${cyc}z.nc`
       do
         if [ -f ${combinefields} ]
         then
           if [ $SENDDBN = YES ]; then
     ...
     if [ -s $DATA/${PREFIXNOS}.avg.nowcast.$PDY.t${cyc}z.nc ]; then
       for combinefields in `ls $COMOUT/${PREFIXNOS}.avg.n*.nc`
       do
         if [ -f ${combinefields} ]
         then
           if [ $SENDDBN = YES ]; then
       ...
       for combinefields in `ls $COMOUT/${PREFIXNOS}.fields.n*t${cyc}z.nc`
       do
         if [ -f ${combinefields} ]
         then
           if [ $SENDDBN = YES ]; then
...
#    then
     if [ -s $DATA/${PREFIXNOS}.2ds.f003.$PDY.t${cyc}z.nc ]; then 
       for combinefields in `ls $COMOUT/${PREFIXNOS}.2ds.f*t${cyc}z.nc`
       do
         if [ -f ${combinefields} ]
         then
           if [ $SENDDBN = YES ]; then
       ...
       for combinefields in `ls $COMOUT/${PREFIXNOS}.fields.f*t${cyc}z.nc`
       do
         if [ -f ${combinefields} ]
         then
           if [ $SENDDBN = YES ]; then
     ...
     if [ -s $DATA/${PREFIXNOS}.avg.forecast.$PDY.t${cyc}z.nc ]; then
       for combinefields in `ls $COMOUT/${PREFIXNOS}.avg.f*.nc`
       do
         if [ -f ${combinefields} ]
         then
           if [ $SENDDBN = YES ]; then
