...
##--------------------------------------------------------------#
  ...
  RST_FILE=$COMOUTroot/${RUN}.$YYYY$MM$DD/${PREFIXNOS}.rst.nowcast.$YYYY$MM$DD.t${HH}z.nc
  if [ $OCEAN_MODEL == "SELFE" ]; then
    RST_FILE=$COMOUTroot/${RUN}.$YYYY$MM$DD/${PREFIXNOS}.rst.nowcast.$YYYY$MM$DD.t${HH}z.bin
  fi
  while [ ! -s $RST_FILE ]
  do
...
# For operational runs, no cold start is allowed
    ...
    echo 'nowcast from hot restart file: ' ${PREFIXNOS}.rst.nowcast.$YYYY$MM$DD.t${HH}z.nc >> $cormslogfile
    echo 'nowcast from hot restart file: ' ${PREFIXNOS}.rst.nowcast.$YYYY$MM$DD.t${HH}z.nc >> $jlogfile
    echo 'nowcast from hot restart file: ' ${PREFIXNOS}.rst.nowcast.$YYYY$MM$DD.t${HH}z.nc >> $nosjlogfile
    INI_FILE=$RST_FILE
    if [ $OCEAN_MODEL == "SELFE" ]; then
  ...
  export INI_FILE_ROMS=${PREFIXNOS}.init.nowcast.$YYYY$MM$DD.t${cyc}z.nc
  if [ $OCEAN_MODEL == "SELFE" -o $OCEAN_MODEL == "selfe" ]; then
    export INI_FILE_ROMS=${PREFIXNOS}.init.nowcast.$YYYY$MM$DD.t${cyc}z.bin
  fi 
...
export OBC_FORCING_FILE=${PREFIXNOS}.obc.$PDY1.t${cyc}z.nc
export OBC_FORCING_FILE_EL=${PREFIXNOS}.obc.el.$PDY1.t${cyc}z.nc
export OBC_FORCING_FILE_TS=${PREFIXNOS}.obc.ts.$PDY1.t${cyc}z.nc
export RIVER_FORCING_FILE=${PREFIXNOS}.river.$PDY1.t${cyc}z.nc
export OBC_TIDALFORCING_FILE=${PREFIXNOS}.roms.tides.$PDY1.t${cyc}z.nc
export NUDG_FORCING_FILE=${PREFIXNOS}.clim.$PDY1.t${cyc}z.nc
...
export INI_FILE_NOWCAST=${PREFIXNOS}.init.nowcast.$PDY1.t${cyc}z.nc
export HIS_OUT_NOWCAST=${PREFIXNOS}.fields.nowcast.$PDY1.t${cyc}z.nc
export STA_OUT_NOWCAST=${PREFIXNOS}.stations.nowcast.$PDY1.t${cyc}z.nc
export RST_OUT_NOWCAST=${PREFIXNOS}.rst.nowcast.$PDY1.t${cyc}z.nc
export MET_NETCDF_1_NOWCAST=${PREFIXNOS}.met.nowcast.$PDY1.t${cyc}z.nc
export MET_NETCDF_2_NOWCAST=${PREFIXNOS}.hflux.nowcast.$PDY1.t${cyc}z.nc
export HIS_2D_NOWCAST=${PREFIXNOS}.surface.nowcast.$PDY1.t${cyc}z.nc
export HIS_2D_FORECAST=${PREFIXNOS}.surface.forecast.$PDY1.t${cyc}z.nc
export INI_FILE_FORECAST=$RST_OUT_NOWCAST
export HIS_OUT_FORECAST=${PREFIXNOS}.fields.forecast.$PDY1.t${cyc}z.nc
export STA_OUT_FORECAST=${PREFIXNOS}.stations.forecast.$PDY1.t${cyc}z.nc
export RST_OUT_FORECAST=${PREFIXNOS}.rst.forecast.$PDY1.t${cyc}z.nc
export MET_NETCDF_1_FORECAST=${PREFIXNOS}.met.forecast.$PDY1.t${cyc}z.nc
export MET_NETCDF_2_FORECAST=${PREFIXNOS}.hflux.forecast.$PDY1.t${cyc}z.nc
export MODEL_LOG_NOWCAST=${PREFIXNOS}.nowcast.$PDY1.t${cyc}z.log
export MODEL_LOG_FORECAST=${PREFIXNOS}.forecast.$PDY1.t${cyc}z.log
export RUNTIME_CTL_NOWCAST=${PREFIXNOS}.nowcast.$PDY1.t${cyc}z.in
export RUNTIME_CTL_FORECAST=${PREFIXNOS}.forecast.$PDY1.t${cyc}z.in
if [ -z "${OFS##wcofs_da*}" ]; then
  export COMOUTrst1=$COMrst/${OFS_NF}.$PDY1
  export RST_OUT_NOWCAST_NF1=nos.${OFS_NF}.rst.nowcast.$PDY1.t${HH}z.nc
  ...
  PDY_NF=$YYYY$MM$DD
  HH_NF=$HH1
  export RST_OUT_NOWCAST_NF2=nos.${OFS_NF}.rst.nowcast.$PDY_NF.t${HH_NF}z.nc
  export COMOUTrst2=$COMrst/${OFS_NF}.$PDY_NF
fi
if [ ${OCEAN_MODEL} == "SELFE" -o ${OCEAN_MODEL} == "selfe" ]; then
  export MET_NETCDF_1_NOWCAST=${PREFIXNOS}.met.nowcast.$PDY1.t${cyc}z.nc.tar
  export MET_NETCDF_1_FORECAST=${PREFIXNOS}.met.forecast.$PDY1.t${cyc}z.nc.tar
  export OBC_FORCING_FILE=${PREFIXNOS}.obc.$PDY1.t${cyc}z.tar
  export OBC_FORCING_FILE_EL=${PREFIXNOS}.obc.el.$PDY1.t${cyc}z.tar
  export OBC_FORCING_FILE_TS=${PREFIXNOS}.obc.ts.$PDY1.t${cyc}z.tar
  export RIVER_FORCING_FILE=${PREFIXNOS}.river.$PDY1.t${cyc}z.th.tar
  export INI_FILE_NOWCAST=${PREFIXNOS}.init.nowcast.$PDY1.t${cyc}z.bin
  export RST_OUT_NOWCAST=${PREFIXNOS}.rst.nowcast.$PDY1.t${cyc}z.bin
  export RST_OUT_FORECAST=${PREFIXNOS}.rst.forecast.$PDY1.t${cyc}z.bin
  export INI_FILE_FORECAST=$RST_OUT_NOWCAST
  export RUNTIME_MET_CTL_NOWCAST=${PREFIXNOS}.met_ctl.nowcast.$PDY1.t${cyc}z.in
  export RUNTIME_MET_CTL_FORECAST=${PREFIXNOS}.met_ctl.forecast.$PDY1.t${cyc}z.in
  export RUNTIME_COMBINE_RST_NOWCAST=${PREFIXNOS}.combine.hotstart.nowcast.$PDY1.t${cyc}z.in
  export RUNTIME_COMBINE_NETCDF_NOWCAST=${PREFIXNOS}.combine.netcdf.nowcast.$PDY1.t${cyc}z.in
  export RUNTIME_COMBINE_NETCDF_FORECAST=${PREFIXNOS}.combine.netcdf.forecast.$PDY1.t${cyc}z.in
  export RUNTIME_COMBINE_NETCDF_STA_NOWCAST=${PREFIXNOS}.combine.netcdf.sta.nowcast.$PDY1.t${cyc}z.in
  export RUNTIME_COMBINE_NETCDF_STA_FORECAST=${PREFIXNOS}.combine.netcdf.sta.forecast.$PDY1.t${cyc}z.in
elif [ ${OCEAN_MODEL} == "FVCOM" -o ${OCEAN_MODEL} == "fvcom" ]; then
  export RIVER_FORCING_FILE=${PREFIXNOS}.river.$PDY1.t${cyc}z.nc.tar
fi
